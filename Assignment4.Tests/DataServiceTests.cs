    ...
    public class DataServiceTests
    {
        ...
        [Fact]
             public void OrderDetails_Object_HasOrderProductUnitPriceQuantityAndDiscount()
            {
                ...
                Assert.Equal(0.0m, orderDetails.UnitPrice);
                Assert.Equal(0.0m, orderDetails.Quantity);
         ...
         public void GetOrderDetailByProductId_ValidId_ReturnsOrderDateUnitPriceAndQuantity()
        {
            ...
            Assert.Equal("1997-05-06", orderDetails.First().Order.OrderDate.ToString("yyyy-MM-dd"));
